...
color: 'ชมพู',
sciname: 'Paeonia',
meaning: 'ดอกโบตั๋น เป็นสัญลักษณ์ของความรักใคร่ ความสวยงามของเพศหญิงและความรู้สึก ที่เป็นไปด้วยความรักของหนุ่มสาวและใช้เป็นสัญลักษณ์ตกแต่งหลักในศิลปะต่างๆของจีน เพื่อดึงดูดความรักและความมั่งคั่งร่ำรวย',
giving: 'มอบให้เพื่อความโชคดี โชคลาภ' }
        ...
        return (
            <ImageBackground source={require('./image/LifeisVeryBeautiful.jpg')} style={styles.backgroundImage}>
                <View style={styles.container}>
                    ...
                    <View style={styles.container}>
                        <Image source={require('./image/exflower/peony.jpg')}
