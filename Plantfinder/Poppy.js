...
{name:'ดอกป๊อปปี้', 
color: 'แดง',
sciname:' Papaver rhoeas', 
meaning: 'ดอกป๊อปปี้” ในทางสากลแล้ว ถือว่าเป็นดอกไม้ที่สื่อความหมายถึง ทหารผ่านศึกพลีเลือดเนื้อและชีวิตเพื่อปกป้องมาตุภูมิอันเป็นที่รัก และในประเทศไทยยังกำหนดให้เป็นสัญลักษณ์ของ วันทหารผ่านศึก  3 กุมภาพันธ์ของทุกปีอีกด้วย ซึ่งในวันนี้ดอกป๊อปปี้สีแดงจะบานสะพรั่งไปทั่วแผ่นดิน', 
giving: 'วันทหารผ่านศึก' }
        ...
        return (
            <ImageBackground source={require('./image/LifeisVeryBeautiful.jpg')} style={styles.backgroundImage}>
                <View style={styles.container}>
                    ...
                    <View style={styles.container}>
                        <Image source={require('./image/exflower/popy.jpg')}
