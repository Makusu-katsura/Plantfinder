...
color: 'ม่วง',
sciname: 'Gomphrena globosa',
meaning: 'ดอกบานไม่รู้โรย เป็นดอกไม้ที่ช่วยเสริมความแข็งแรงด้านความรัก ให้ผลิบานไม่รู้โรย ทำให้ผู้ที่อยู่อาศัยในบ้านมีความผูกพันต่อกันยาวนาน เชื่อว่าหากบ้านใดปลูกดอกบานไม่รู้โรยแล้ว จะทำให้คู่รักนั้นรักกันยาวนานแสนนาน และไม่ค่อยทะเลาะกัน',
giving: 'มอบให้เพื่อความมงคล รักกันนาน'}
        ...
        return (
            <ImageBackground source={require('./image/LifeisVeryBeautiful.jpg')} style={styles.backgroundImage}>
                <View style={styles.container}>
                    ...
                    <View style={styles.container}>
                        <Image source={require('./image/exflower/Globeamaranth.jpg')}
